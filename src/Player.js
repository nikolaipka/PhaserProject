 var Player = (function(){
	...
	Player.prototype.drawHealthBar = function (color) {
		   ...
		   this.healthBarShape.drawRect(this.x - healthBarShapeWidth / 2, this.y - this.height - 10, healthBarShapeWidth, 3); // (x, y, w, h)
		 };
